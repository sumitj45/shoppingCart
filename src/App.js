...
function App() {
    const [products, setproducts] = useState([{
            ...
            name: 'T-shirt',
            price: 499,
            image: 'https://i.ibb.co/kKdVZVQ/TSHIRT.jpg'
        },
        {
            id: 2,
            name: 'Jeans',
            price: 1699,
            image: 'https://i.ibb.co/3zPwm2S/jeans.webp'
        },
        {
            id: 3,
            name: 'Shoes',
            price: 7999,
            image: 'https://i.ibb.co/9HcxW5S/shoes.jpg'
        }
    ]);
    ...
    const addCourseToCartFunction = (GFGcourse) => {
        ...
        if (alreadyproducts) {
            ...
            setCartproducts([...cartproducts, { product: GFGcourse, quantity: 1 }]);
        }
    };
    ...
    return ( <
        div className = "App" > { /* search component */ } {
        ...
        ShowCourseComponent products = { products }
